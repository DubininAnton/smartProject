/* blockCards - это тег куда вставляются карточки,
 topsales - это массив данных про выбранные карточки*/
const cards = (blockCards, topsales) => {
    const cardsBlock = document.querySelectorAll(blockCards);
  
        cardsBlock.forEach(itemBlock=>{
