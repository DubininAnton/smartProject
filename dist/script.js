...
/* harmony import */ var _modules_navbar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/navbar */ "./src/js/modules/navbar.js");
/* harmony import */ var _modules_subnavbar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/subnavbar */ "./src/js/modules/subnavbar.js");
/* harmony import */ var _modules_mainBlock__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/mainBlock */ "./src/js/modules/mainBlock.js");
/* harmony import */ var _modules_stocks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/stocks */ "./src/js/modules/stocks.js");
/* harmony import */ var _modules_stocksItem__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/stocksItem */ "./src/js/modules/stocksItem.js");
/* harmony import */ var _modules_contacts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/contacts */ "./src/js/modules/contacts.js");
...
/* harmony import */ var _modules_catalog__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/catalog */ "./src/js/modules/catalog.js");
/* harmony import */ var _modules_catalog768__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/catalog768 */ "./src/js/modules/catalog768.js");
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_navbar__WEBPACK_IMPORTED_MODULE_0__["default"])(".navbar__wrapper");
  Object(_modules_subnavbar__WEBPACK_IMPORTED_MODULE_1__["default"])(".subnavbar__catalog");
  Object(_modules_mainBlock__WEBPACK_IMPORTED_MODULE_2__["default"])(".bestsalesCard");
  Object(_modules_subnavbar__WEBPACK_IMPORTED_MODULE_1__["subnavbar768"])(".subnavbar768", ".catalog", ".more", ".search", "#formData");
  Object(_modules_stocks__WEBPACK_IMPORTED_MODULE_3__["default"])(".stocks__pageStocks", ".stocks__btn");
  Object(_modules_stocksItem__WEBPACK_IMPORTED_MODULE_4__["default"])(".stocks__aboutUsTitle", ".stocks__stocks", ".stocks__container", ".stocks__aboutUsTitle320");
  Object(_modules_contacts__WEBPACK_IMPORTED_MODULE_5__["default"])(".contacts__table", ".contacts__adress", ".contacts__cart");
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_6__["default"])();
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_7__["default"])(".accordion");
  Object(_modules_catalog__WEBPACK_IMPORTED_MODULE_8__["default"])(".catalogMain");
  Object(_modules_catalog768__WEBPACK_IMPORTED_MODULE_9__["default"])();
});
...
var accordion = function accordion(_accordion) {
  try {
    var accordionBlock = document.querySelector(_accordion);
    var collapsIndex = "";
    var headingIndex = "";
    var getBlockVacancy = function getBlockVacancy(res) {
      res.forEach(function (vacancy, key) {
        switch (key) {
          case 0:
        ...
        accordionButton.setAttribute("data-bs-target", "#".concat(collapsIndex));
        accordionButton.setAttribute("aria-expanded", "true");
        accordionButton.setAttribute("aria-controls", "".concat(collapsIndex));
        accordionButton.innerHTML = "".concat(vacancy.nameVacancy);
        var accordionCollaps = document.createElement("div");
        accordionCollaps.setAttribute("class", "accordion-collapse collapse show");
        accordionCollaps.setAttribute("aria-labelledby", "".concat(headingIndex));
        accordionCollaps.setAttribute("data-bs-parent", "#accordionExample");
        accordionCollaps.setAttribute("data-bs-target", "#".concat(collapsIndex));
        accordionCollaps.setAttribute("id", "".concat(collapsIndex));
        var accordionBody = document.createElement("div");
        accordionBody.setAttribute("class", "accordion-body");
        /* General info `Мы ищем тех, кто` */
        var generalTitleBlock = document.createElement("h2");
        generalTitleBlock.innerHTML = vacancy.generalTitle;
        accordionBody.appendChild(generalTitleBlock);
        for (var i = 0; i < "".concat(vacancy.generalDescr.length); i++) {
          var generalDescrItem = document.createElement("li");
          generalDescrItem.innerHTML = "".concat(vacancy.generalDescr[i]);
          accordionBody.appendChild(generalDescrItem);
        }
        /* Требования */
        var requirementsTitleBlock = document.createElement("h2");
        requirementsTitleBlock.innerHTML = vacancy.requirementsTitle;
        accordionBody.appendChild(requirementsTitleBlock);
        for (var _i = 0; _i < "".concat(vacancy.requirements.length); _i++) {
          var requirementsDescrItem = document.createElement("li");
          requirementsDescrItem.innerHTML = "".concat(vacancy.requirements[_i]);
          accordionBody.appendChild(requirementsDescrItem);
        }
        /* Условия */
        var conditionsTitleBlock = document.createElement("h2");
        conditionsTitleBlock.innerHTML = vacancy.conditionsTitle;
        accordionBody.appendChild(conditionsTitleBlock);
        for (var _i2 = 0; _i2 < "".concat(vacancy.requirements.length); _i2++) {
          var conditionsDescrItem = document.createElement("li");
          conditionsDescrItem.innerHTML = "".concat(vacancy.conditions[_i2]);
    ...
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResourse"])("http://localhost:3000/vacancy").then(function (res) {
      return getBlockVacancy(res);
    });
  } catch (error) {}
};
...
var cards = function cards(blockCards, topsales) {
  var cardsBlock = document.querySelectorAll(blockCards);
  cardsBlock.forEach(function (itemBlock) {
    topsales.forEach(function (item) {
      ...
      oldPrice.innerHTML = "".concat(item.oldPrice);
      itemPrice.appendChild(oldPrice);
      var newPrice = document.createElement("div");
      newPrice.setAttribute("class", "price__new");
      newPrice.innerHTML = "".concat(item.newPrice);
      itemPrice.appendChild(newPrice);
      var likeCompare = document.createElement("div");
      likeCompare.setAttribute("class", "likeCompare");
      priceBlock.appendChild(likeCompare);
      var like = document.createElement("img");
      like.setAttribute("src", "".concat(item.like));
      like.setAttribute("id", "".concat(item.dataLike));
      like.setAttribute("alt", "like");
      like.setAttribute("class", "like");
      likeCompare.appendChild(like);
      var compare = document.createElement("img");
      compare.setAttribute("src", "".concat(item.compare));
      compare.setAttribute("id", "".concat(item.dataCompare));
      ...
      oneClick.innerHTML = "".concat(item.oneClick);
      btnBlock.appendChild(oneClick);
      var cart = document.createElement("img");
      cart.setAttribute("src", "".concat(item.cart));
...
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../services/requests */ "./src/js/services/requests.js");
/* harmony import */ var _cards__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./cards */ "./src/js/modules/cards.js");
...
var catalog = function catalog(_catalog) {
  try {
    var newArray = []; /* Массив данных при работе с фильтрами */
    var getThereArray = []; /* Массив товаров полученный от сервера, используется для работы с фильтрами */
    var transformArray = []; /* Изененный фильтрами массив товаров (всеми кроме цены)*/
    var choiceIllumination = null; /* Выбор подсветки есть или нет */
    var choicePowerEngine = null; /* Выбор мощности двигателя */
    var choiceMaxSpeed = null; /* Выбор максимальной скорости */
    var maxPrice; /* Максимальная цена выбранных товаров */
    var filterationPrice = null;
    var selectionOrderFilters = []; /* Массив с порядком выбора фильтров */

    /* Эта переменная из locslStorage :) */
    var click = localStorage.getItem("clickItem");
    var catalogBlock = document.querySelector(_catalog);
    var catalogItem = catalogBlock.querySelector(".catalogMain__item");
    var blockA = catalogBlock.querySelector(".catalogBlock__aWrapper");

    /* Обрабатываю запрос с сервера */
    var showProduct = function showProduct(res) {
      var array = res.filter(function (item) {
        return item["class"] === click;
      });
      getThereArray = array;
      catalogItem.innerHTML = array[0].title;
      filters(array); /* Делаем фильтры слева */
      transformArray = _toConsumableArray(array);
      Object(_cards__WEBPACK_IMPORTED_MODULE_22__["default"])(".catalogBlock__d", array); /* Функция отрисовывает карточки товаров справа*/
    };

    /* Функция формирует фильтры (слева странице) */
    var filters = function filters(array) {
      ...
      var price = array.filter(function (item) {
        return item.newPrice;
      }); /* Массив товаров с ценами */
      var illumination = array.filter(function (item) {
        return item.illumination;
      }); /* Массив товаров с подсветкой */
      var enginePower = array.filter(function (item) {
        return item.enginePower;
      }); /* Массив товаров у которых есть характеристика про мощность двигателя */
      var maxSpeed = array.filter(function (item) {
        return item.maxSpeed;
      }); /* Массив товаров у которых есть характеристика "максимальная скорость" */
      ...
      if (price.length !== 0) {
        ...
        /* Формирую тег форм*/
        var _formPrice = document.createElement("form");
        _formPrice.setAttribute("class", "catalogBlock__form");

        /* Формирую тег инпут с минимальной ценой и его лейбл */
        var lowPriceLabel = document.createElement("label");
        lowPriceLabel.setAttribute("class", "catalogBlock__lowPriceLabel");
        lowPriceLabel.innerHTML = "от";
        var lowPrice = document.createElement("input");
        ...
        var hightPriceLabel = document.createElement("label");
        hightPriceLabel.setAttribute("class", "catalogBlock__hightPriceLabel");
        hightPriceLabel.innerHTML = "до";
        var hightPrice = document.createElement("input");
        hightPrice.setAttribute("class", "catalogBlock__hightPrice");

        /* Формирую полосу прокрутки цены */
        var _rangePrice = document.createElement("input");
        _rangePrice.setAttribute("class", "catalogBlock__rangePrice");
        _rangePrice.setAttribute("type", "range");
        _rangePrice.setAttribute("min", "0");
        _rangePrice.setAttribute("max", "");
        ...
        _formPrice.appendChild(lowPriceLabel);
        _formPrice.appendChild(lowPrice);
        _formPrice.appendChild(hightPriceLabel);
        _formPrice.appendChild(hightPrice);
        rowOne.appendChild(_formPrice);
        _formPrice.appendChild(_rangePrice);
        _formPrice.appendChild(buttonPrice);
      ...
      var maxPriceString = array.map(function (item) {
        return item.newPrice;
      }); /* Массив значений цены в виде строк */
      var maxPriceNumber = maxPriceString.map(function (item) {
        return parseInt(item);
      }); /* Массив значений цен в виде чисел */
      maxPrice = Math.max.apply(Math, _toConsumableArray(maxPriceNumber)); /* Максимальная цена */
      var inputMaxPrice = document.querySelector(".catalogBlock__hightPrice");
      var rangePrice = document.querySelector(".catalogBlock__rangePrice");
      ...
      rangePrice.addEventListener("change", function (e) {
      ...
      var formPrice = document.querySelector(".catalogBlock__form");
      formPrice.addEventListener("submit", function (e) {
        e.preventDefault();
        var newArray = getThereArray.filter(function (item) {
          return item.myPrice <= inputMaxPrice.value;
        });
        transformArray = [];
        transformArray = _toConsumableArray(newArray);
      ...
      if (illumination.length !== 0) {
        /* Один Item раскрывающегося меню */
        var _accordionItem = document.createElement("div");
        _accordionItem.setAttribute("class", "accordion-item");
        /* Header одного Item открывающегося меню */
        var _accordionHeader = document.createElement("h2");
        _accordionHeader.setAttribute("class", "accordion-header");
        _accordionHeader.setAttribute("id", "panelsStayOpen-headingTwo");
        /* Кнопка одного Item открывающегося меню */
        var _accordionButton = document.createElement("div");
        _accordionButton.setAttribute("class", "accordion-button");
        _accordionButton.setAttribute("type", "button");
        _accordionButton.setAttribute("data-bs-toggle", "collapse");
        _accordionButton.setAttribute("data-bs-target", "#panelsStayOpen-collapseTwo");
        _accordionButton.setAttribute("aria-expanded", "true");
        _accordionButton.setAttribute("aria-controls", "panelsStayOpen-collapseTwo");
        _accordionButton.innerHTML = "\u041F\u043E\u0434\u0441\u0432\u0435\u0442\u043A\u0430";
        /* Тело одного Item открывающегося меню */
        var _accordionCollaps = document.createElement("div");
        _accordionCollaps.setAttribute("class", "accordion-collapse collapse");
        _accordionCollaps.setAttribute("aria-labelledby", "headingTwo");
        _accordionCollaps.setAttribute("data-bs-parent", "#accordionExample");
        _accordionCollaps.setAttribute("data-bs-target", "collapseTwo");
        _accordionCollaps.setAttribute("id", "panelsStayOpen-collapseTwo");
        /* Элемент куда вставляется информация в открывающемся меню */
        var _accordionBody = document.createElement("div");
        _accordionBody.setAttribute("class", "accordion-body");
        /* Пункты меню "есть" или "нет" подсветки */
        var illuminationForm = document.createElement("form");
        illuminationForm.setAttribute("class", "catalogBlock__illumination");
        /* Галочка "есть" в "подсветке" */
        var illuminationRowOne = document.createElement("div");
        illuminationRowOne.setAttribute("class", "catalogBlock__illuminationRowOne");
        var illuminationTrue = document.createElement("input");
        ...
        var illuminationTrueLabel = document.createElement("label");
        ...
        var illuminationRowTwo = document.createElement("div");
        illuminationRowTwo.setAttribute("class", "catalogBlock__illuminationRowTwo");
        var illuminationFalse = document.createElement("input");
        ...
        var illuminationFalseLabel = document.createElement("label");
        ...
        _accordionBody.appendChild(illuminationForm);
        _accordionCollaps.appendChild(_accordionBody);
        _accordionHeader.appendChild(_accordionButton);
        _accordionItem.appendChild(_accordionHeader);
        accordion.appendChild(_accordionItem);
        _accordionItem.appendChild(_accordionCollaps);

        /* Переключаю checkbox чтобы был нажат только Есть или Нет */
        var checkbox = function checkbox() {
          var checkboxTrue = document.querySelector(".catalogBlock__illuninationTrue");
          var checkboxFalse = document.querySelector(".catalogBlock__illuninationFalse");
          checkboxTrue.addEventListener("click", function () {
      ...
      if (enginePower.length !== 0) {
        /* Один Item раскрывающегося меню */
        var _accordionItem2 = document.createElement("div");
        _accordionItem2.setAttribute("class", "accordion-item");
        /* Header одного Item открывающегося меню */
        var _accordionHeader2 = document.createElement("h2");
        _accordionHeader2.setAttribute("class", "accordion-header");
        _accordionHeader2.setAttribute("id", "panelsStayOpen-headingThree");
        /* Кнопка одного Item открывающегося меню */
        var _accordionButton2 = document.createElement("div");
        _accordionButton2.setAttribute("class", "accordion-button");
        _accordionButton2.setAttribute("type", "button");
        _accordionButton2.setAttribute("data-bs-toggle", "collapse");
        _accordionButton2.setAttribute("data-bs-target", "#panelsStayOpen-collapseThree");
        _accordionButton2.setAttribute("aria-expanded", "true");
        _accordionButton2.setAttribute("aria-controls", "panelsStayOpen-collapseThree");
        _accordionButton2.innerHTML = "\u041C\u043E\u0449\u043D\u043E\u0441\u0442\u044C \u0434\u0432\u0438\u0433\u0430\u0442\u0435\u043B\u044F, \u0412\u0442";
        /* Тело одного Item открывающегося меню */
        var _accordionCollaps2 = document.createElement("div");
        _accordionCollaps2.setAttribute("class", "accordion-collapse collapse");
        _accordionCollaps2.setAttribute("aria-labelledby", "headingThree");
        _accordionCollaps2.setAttribute("data-bs-parent", "#accordionExample");
        _accordionCollaps2.setAttribute("data-bs-target", "collapseThree");
        _accordionCollaps2.setAttribute("id", "panelsStayOpen-collapseThree");
        /* Элемент куда вставляется информация в открывающемся меню */
        var _accordionBody2 = document.createElement("div");
        _accordionBody2.setAttribute("class", "accordion-body");
        /* Форма с возможными вариантами мощности двигателя */
        var powerEngineForm = document.createElement("form");
        powerEngineForm.setAttribute("class", "catalogBlock__powerEngine");
        /* Возможные варианты мощности двигателя */
        var powerEngineArray = enginePower.map(function (item) {
          return item.enginePower;
        }); /* Массив мощностей двигателя */
        var noDublicatePowerEngineArray = powerEngineArray.filter(function (x, i) {
          return powerEngineArray.indexOf(x) === i;
        }); /* Из массива убраны повторяющиеся значения мощностей */
        var sortNoDublicatePowerEngineArray = noDublicatePowerEngineArray.sort(function (a, b) {
          return a - b;
        }); /* Элементы в массиве расставленв в порядке возрастания */
        /* Перебираю массив и формирую input */
        sortNoDublicatePowerEngineArray.forEach(function (item) {
          var powerEngineRowOne = document.createElement("div");
          powerEngineRowOne.setAttribute("class", "catalogBlock__powerEngineRowOne");
          var powerEngineElement = document.createElement("input");
          ...
          var powerEngineElementLabel = document.createElement("label");
          powerEngineElementLabel.setAttribute("class", "catalogBlock__powerEngineElementLabel");
          powerEngineElementLabel.innerHTML = "".concat(item);
          var powerEngineElementCount = document.createElement("span");
          powerEngineElementCount.innerHTML = "(".concat(powerEngineArray.filter(function (product) {
            return product === item;
          }).length, ")");
        ...
        _accordionBody2.appendChild(powerEngineForm);
        _accordionCollaps2.appendChild(_accordionBody2);
        _accordionHeader2.appendChild(_accordionButton2);
        _accordionItem2.appendChild(_accordionHeader2);
        accordion.appendChild(_accordionItem2);
        _accordionItem2.appendChild(_accordionCollaps2);
      }

      /* Навешиваю слушетели на элементы нисподающего меню "Мощность двигателя" */
      var selectedPowerEngine = document.querySelectorAll(".catalogBlock__powerEngineElement");
      selectedPowerEngine.forEach(function (item) {
        item.addEventListener("click", function (e) {
          selectedPowerEngine.forEach(function (point) {
            if (point !== e.target) {
              point.checked = false;
            }
          });
      ...
      if (maxSpeed.length !== 0) {
        /* Один Item раскрывающегося меню */
        var _accordionItem3 = document.createElement("div");
        _accordionItem3.setAttribute("class", "accordion-item");
        /* Header одного Item открывающегося меню */
        var _accordionHeader3 = document.createElement("h2");
        _accordionHeader3.setAttribute("class", "accordion-header");
        _accordionHeader3.setAttribute("id", "panelsStayOpen-headingFour");
        /* Кнопка одного Item открывающегося меню */
        var _accordionButton3 = document.createElement("div");
        _accordionButton3.setAttribute("class", "accordion-button");
        _accordionButton3.setAttribute("type", "button");
        _accordionButton3.setAttribute("data-bs-toggle", "collapse");
        _accordionButton3.setAttribute("data-bs-target", "#panelsStayOpen-collapseFour");
        _accordionButton3.setAttribute("aria-expanded", "true");
        _accordionButton3.setAttribute("aria-controls", "panelsStayOpen-collapseFour");
        _accordionButton3.innerHTML = "\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0441\u043A\u043E\u0440\u043E\u0441\u0442\u044C (\u043A\u043C/\u0447)";
        /* Тело одного Item открывающегося меню */
        var _accordionCollaps3 = document.createElement("div");
        _accordionCollaps3.setAttribute("class", "accordion-collapse collapse");
        _accordionCollaps3.setAttribute("aria-labelledby", "headingFour");
        _accordionCollaps3.setAttribute("data-bs-parent", "#accordionExample");
        _accordionCollaps3.setAttribute("data-bs-target", "collapseFour");
        _accordionCollaps3.setAttribute("id", "panelsStayOpen-collapseFour");
        /* Элемент куда вставляется информация в открывающемся меню */
        var _accordionBody3 = document.createElement("div");
        _accordionBody3.setAttribute("class", "accordion-body");
        /* Форма с возможными вариантами характеристик "максимальная скорость" */
        var maxSpeedForm = document.createElement("form");
        maxSpeedForm.setAttribute("class", "catalogBlock__maxSpeed");
        /* Возможные варианты мощности двигателя */
        var maxSpeedArray = enginePower.map(function (item) {
          return item.maxSpeed;
        }); /* Массив "максимальная скорость" */
        var noDublicateMaxSpeedArray = maxSpeedArray.filter(function (x, i) {
          return maxSpeedArray.indexOf(x) === i;
        }); /* Из массива убраны повторяющиеся значения максимальных скоростей */
        var sortNoDublicateMaxSpeedArray = noDublicateMaxSpeedArray.sort(function (a, b) {
          return a - b;
        }); /* Элементы в массиве расставленв в порядке возрастания */
        /* Перебираю массив и формирую input */
        sortNoDublicateMaxSpeedArray.forEach(function (item) {
          var powerEngineRowOne = document.createElement("div");
          powerEngineRowOne.setAttribute("class", "catalogBlock__maxSpeedRowOne");
          var maxSpeedElement = document.createElement("input");
          ...
          var maxSpeedElementLabel = document.createElement("label");
          maxSpeedElementLabel.setAttribute("class", "catalogBlock__maxSpeedElementLabel");
          maxSpeedElementLabel.innerHTML = "".concat(item);
          var maxSpeedElementCount = document.createElement("span");
          maxSpeedElementCount.innerHTML = "(".concat(maxSpeedArray.filter(function (product) {
            return product === item;
          }).length, ")");
          /* На строчку выше в границах <span> определяется количество товаров с данной мощностью двигателя */
        ...
        _accordionBody3.appendChild(maxSpeedForm);
        _accordionCollaps3.appendChild(_accordionBody3);
        _accordionHeader3.appendChild(_accordionButton3);
        _accordionItem3.appendChild(_accordionHeader3);
        accordion.appendChild(_accordionItem3);
        _accordionItem3.appendChild(_accordionCollaps3);
      }

      /* Навешиваю слушетели на элементы нисподающего меню "Максимальная скорость" */
      var selectedMaxSpeed = document.querySelectorAll(".catalogBlock__maxSpeedElement");
      selectedMaxSpeed.forEach(function (item) {
        item.addEventListener("click", function (e) {
          selectedMaxSpeed.forEach(function (point) {
            if (point !== e.target) {
              point.checked = false;
            }
          });
      ...
      var btnDropdown = document.querySelector(".btn.dropdown-toggle");
      var itemDropdown = document.querySelectorAll(".dropdown-item");
      itemDropdown.forEach(function (item) {
        item.addEventListener("click", function (e) {
          btnDropdown.innerHTML = "".concat(e.target.textContent);
    ...
    var funcSelectionOrderFilters = function funcSelectionOrderFilters(filter) {
      var inputMaxPrice = document.querySelector(".catalogBlock__hightPrice");
      switch (filter) {
    ...
    var preparationArray = function preparationArray() {
      var blockD = document.querySelector(".catalogBlock__d");
      blockD.innerHTML = "";
      /* ВАРИАНТ №2 РАБОТАЕТ*/
      if (selectionOrderFilters.length !== 0) {
        selectionOrderFilters.forEach(function (item, key) {
          if (key === 0) {
            if (item === "changePrice") {
            ...
            if (item === "choiceIllumination") {
              if (choiceIllumination === true) {
                newArray = transformArray.filter(function (item) {
                  return item.illumination === true;
                });
              }
              if (choiceIllumination === false) {
                newArray = transformArray.filter(function (item) {
                  return item.illumination === false;
                });
              }
            }
            if (item === "choicePowerEngine") {
              newArray = transformArray.filter(function (item) {
                return item.enginePower == choicePowerEngine;
              });
            }
            if (item === "choiceMaxSpeed") {
              newArray = transformArray.filter(function (item) {
                return item.maxSpeed == choiceMaxSpeed;
              });
            }
          }
          if (key === 1) {
          ...
          if (key === 2) {
            if (item === "changePrice") {
              var _inputMaxPrice = document.querySelector(".catalogBlock__hightPrice");
              newArray = newArray.filter(function (item) {
                return item.myPrice <= _inputMaxPrice.value;
              });
            }
            if (item === "choiceIllumination") {
              if (choiceIllumination === true) {
          ...
          if (key === 3) {
            if (item === "changePrice") {
              var _inputMaxPrice2 = document.querySelector(".catalogBlock__hightPrice");
              newArray = newArray.filter(function (item) {
                return item.myPrice <= _inputMaxPrice2.value;
              });
            }
            if (item === "choiceIllumination") {
              if (choiceIllumination === true) {
        ...
        if (filterationPrice == "cheap") {
          newArray = newArray.sort(function (prev, next) {
            return prev.myPrice - next.myPrice;
          });
        }
      ...
      Object(_cards__WEBPACK_IMPORTED_MODULE_22__["default"])(".catalogBlock__d", newArray); /* Функция отрисовывает карточки товаров справа*/
    ...
    var filterOnTop = function filterOnTop() {
      var blockB = document.querySelector(".catalogBlock__b");
      blockB.replaceChildren(); /* Удаляю всех потомков из блока Б */
      /* Подсветка */
      if (choiceIllumination !== null) {
        var filterIllumination = document.createElement("div");
      ...
      /* Цена */
      var choicePrice = document.querySelector(".catalogBlock__hightPrice");
      if (choicePrice.value != maxPrice) {
        ...
        filterPrice.innerHTML = "\u0426\u0435\u043D\u0430: ".concat(choicePrice.value, " \u0420");
        var _cross = document.createElement("div");
        _cross.setAttribute("class", "catalogBlock__filterPriceCross");
        filterPrice.appendChild(_cross);
      ...
      if (choicePowerEngine !== null) {
        var filterPower = document.createElement("div");
        filterPower.setAttribute("class", "catalogBlock__filterPower");
        filterPower.innerHTML = "\u041C\u043E\u0449\u043D\u043E\u0441\u0442\u044C \u0434\u0432\u0438\u0433\u0430\u0442\u0435\u043B\u044F: ".concat(choicePowerEngine, " \u0412\u0442");
        var _cross2 = document.createElement("div");
        _cross2.setAttribute("class", "catalogBlock__filterPowerCross");
        filterPower.appendChild(_cross2);
      ...
      if (choiceMaxSpeed !== null) {
        var filterSpeed = document.createElement("div");
        filterSpeed.setAttribute("class", "catalogBlock__filterSpeed");
        filterSpeed.innerHTML = "\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0441\u043A\u043E\u0440\u043E\u0441\u0442\u044C: ".concat(choiceMaxSpeed, " \u043A\u043C/\u0447");
        var _cross3 = document.createElement("div");
        _cross3.setAttribute("class", "catalogBlock__filterSpeedCross");
        filterSpeed.appendChild(_cross3);
      ...
      if (choiceIllumination !== null || choicePrice.value != maxPrice || choicePowerEngine !== null || choiceMaxSpeed !== null) {
        var eraseAllFilter = document.createElement("div");
    ...
    var buttonEraseAllFilter = function buttonEraseAllFilter() {
      var eraseAll = document.querySelector(".catalogBlock__eraseAllFilter");
    ...
    var eraseButtonAll = function eraseButtonAll() {
      var choicePrice = document.querySelector(".catalogBlock__hightPrice");
      try {
        if (choiceIllumination === null && choicePrice.value == maxPrice && choicePowerEngine === null && choiceMaxSpeed === null) {
          document.querySelector(".catalogBlock__eraseAllFilter").remove();
    ...
    var eraseIllumination = function eraseIllumination() {
      var crossIlluination = document.querySelector(".catalogBlock__filterIlluminationCross");
      var checkboxTrue = document.querySelector(".catalogBlock__illuninationTrue");
      var checkboxFalse = document.querySelector(".catalogBlock__illuninationFalse");
      crossIlluination.addEventListener("click", function () {
        var filterIllumination = document.querySelector(".catalogBlock__filterIllumination");
    ...
    var erasePrice = function erasePrice() {
      var crossPrice = document.querySelector(".catalogBlock__filterPriceCross");
      crossPrice.addEventListener("click", function () {
        var filterPrice = document.querySelector(".catalogBlock__filterPrice");
        filterPrice.remove();
        var choicePrice = document.querySelector(".catalogBlock__hightPrice");
    ...
    var erasePower = function erasePower() {
      var crossPower = document.querySelector(".catalogBlock__filterPowerCross");
      crossPower.addEventListener("click", function () {
        var filterPower = document.querySelector(".catalogBlock__filterPower");
        filterPower.remove();
        choicePowerEngine = null;
        var selectedPowerEngine = document.querySelectorAll(".catalogBlock__powerEngineElement");
        selectedPowerEngine.forEach(function (item) {
    ...
    var eraseSpeed = function eraseSpeed() {
      var crossSpeed = document.querySelector(".catalogBlock__filterSpeedCross");
      crossSpeed.addEventListener("click", function () {
        var filterSpeed = document.querySelector(".catalogBlock__filterSpeed");
        filterSpeed.remove();
        choiceMaxSpeed = null;
        var selectedSpeed = document.querySelectorAll(".catalogBlock__maxSpeedElement");
        selectedSpeed.forEach(function (item) {
          item.checked = null;
        });
        funcSelectionOrderFilters("choiceMaxSpeed");
        eraseButtonAll();
    ...
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_21__["getResourse"])("http://localhost:3000/topSales").then(function (res) {
      return showProduct(res);
    });
  } catch (error) {}
};
...
var catalog768 = function catalog768() {
  if (window.screen.width <= 768) {
    var catalockBlock = document.querySelector(".catalogBlock");
    catalockBlock.style.gridTemplateAreas = '"A C" "D D"';
    catalockBlock.style.width = '728px';
    var catalockBlockD = document.querySelector(".catalogBlock__d");
    catalockBlockD.style.gridTemplateColumns = "repeat(2, 365px)";
    var catalockBlockB = document.querySelector(".catalogBlock__b");
    catalockBlockB.style.display = "none";
    var catalockBlockWrapper = document.querySelector(".catalogMain__wrapper");
    catalockBlockWrapper.style.width = "768px";
    var catalockBlocC = document.querySelector(".catalogBlock__c");
    catalockBlocC.style.width = "100%";
    catalockBlocC.style.marginRight = "0px";
    var catalockBlockABtn = document.querySelector(".catalogBlockA__btn");
    catalockBlockABtn.style.display = "block";
    var modalWindow = function modalWindow() {
      var catalogBlockA = document.querySelector(".catalogBlock__aWrapper");
      ...
      var filterClose = document.createElement("img");
      filterClose.setAttribute("class", "catalogBlockA__filterClose");
      var titleAccordion = document.createElement("div");
      ...
      catalockBlockABtn.addEventListener("click", function () {
        ...
        var cart = document.querySelectorAll("img");
      ...
      var closeBtn = document.querySelector(".catalogBlockA__filterClose");
    ...
    if (window.screen.width <= 320) {
      var _catalockBlock = document.querySelector(".catalogBlock");
      _catalockBlock.style.gridTemplateAreas = '"A" "C" "D';
      _catalockBlock.style.width = '280px';
      var _catalockBlockD = document.querySelector(".catalogBlock__d");
      _catalockBlockD.style.gridTemplateColumns = "repeat(1, 280px)";
      var catalockBlockC = document.querySelector(".catalogBlock__c");
      catalockBlockC.style.display = "none";
      var _catalockBlockWrapper = document.querySelector(".catalogMain__wrapper");
      _catalockBlockWrapper.style.width = "280px";
      _catalockBlockWrapper.style.paddingTop = "0px";
      var catalockBlocA = document.querySelector(".catalogBlock__a");
      catalockBlocA.style.width = "280px";
      var catalockBlocAWrapper = document.querySelector(".catalogBlock__aWrapper");
      catalockBlocAWrapper.style.width = "280px";
      var catalockBlocABtn = document.querySelector(".catalogBlockA__btn");
      catalockBlocABtn.style.width = "280px";
      var _catalockBlocC = document.querySelector(".catalogBlock__c");
      _catalockBlocC.style.display = "block";
      _catalockBlocC.style.width = "280px";
      var catalockBlocBtn = document.querySelector(".btn.dropdown-toggle");
      catalockBlocBtn.style.width = "280px";
      var catalockBlocAccordion = document.querySelector(".accordion");
      catalockBlocAccordion.style.width = "280px";
    }
  }
};
/* harmony default export */ __webpack_exports__["default"] = (catalog768);
...
var contacts = function contacts(table, adressBlock, mapBlock) {
  try {
    ...
    if (window.screen.width <= "320") {
      ...
      var timeWork = document.createElement("div");
    ...
    /* Формируются блоки адресов и карты */
    if (window.screen.width > "320") {
      var _tableBlock = document.querySelector(table);
      var bigBlock = document.createElement("div");
      bigBlock.setAttribute("class", "bigBlock");
      var _cart = document.createElement("div");
      _cart.setAttribute("class", "contacts__cart");
      var _adress = document.createElement("div");
      _adress.setAttribute("class", "contacts__adress");
      var _one = document.createElement("div");
      _one.setAttribute("class", "contacts__one adress");
      _one.setAttribute("id", "one");
      _one.innerHTML = "\n                    <p> \u0421\u041F\u0431, \u0423\u043B. \u0414\u044B\u0431\u0435\u043D\u043A\u043E \u0434.23 \u043A.1 </p>\n                    <span> +7 (812) 509-23-43 </span>\n                ";
      var _two = document.createElement("div");
      _two.setAttribute("class", "contacts__two adress");
      _two.setAttribute("id", "two");
      _two.innerHTML = "\n                    <p> \u0421\u041F\u0431, \u041F\u0440. \u042D\u043D\u0433\u0435\u043B\u044C\u0441\u0430 \u0434.113 \u043A.2 </p>\n                    <span> +7 (812) 509-23-43 </span>\n                ";
      var _three = document.createElement("div");
      _three.setAttribute("class", "contacts__three adress");
      _three.setAttribute("id", "three");
      _three.innerHTML = "\n                    <p> \u0421\u041F\u0431, \u0423\u043B. \u041B\u0435\u043D\u0441\u043E\u0432\u0435\u0442\u0430 \u0434.81 </p>\n                    <span> +7 (812) 602-74-02 </span>\n                ";
      var _four = document.createElement("div");
      _four.setAttribute("class", "contacts__four adress");
      _four.setAttribute("id", "four");
      _four.innerHTML = "\n                    <p> \u0421\u041F\u0431, \u0443\u043B. \u0422\u0430\u0440\u0430\u0441\u043E\u0432\u0430 \u0434.10 </p>\n                    <span> +7 (967) 555-01-06 </span>\n                ";
      var _line = document.createElement("div");
      _line.setAttribute("class", "contacts__line");
      var _link = document.createElement("a");
      _link.setAttribute("class", "contacts__email");
      _link.setAttribute("href", "mailto:smart-tekhnika@gmail.com");
      _link.innerHTML = "smart-tekhnika@gmail.com";
      _line.appendChild(_link);
      var _timeWork = document.createElement("div");
      _timeWork.setAttribute("class", "contacts__timeWork");
      _timeWork.innerHTML = "Режим работы";
      _line.appendChild(_timeWork);
      var _time = document.createElement("div");
      _time.setAttribute("class", "contacts__time");
      _time.innerHTML = "Пн-вс с 10:00 до 21:00";
      _line.appendChild(_time);
      _adress.appendChild(_one);
      _adress.appendChild(_two);
      _adress.appendChild(_three);
      _adress.appendChild(_four);
      _adress.appendChild(_line);
      bigBlock.appendChild(_adress);
      bigBlock.appendChild(_cart);
      _tableBlock.appendChild(bigBlock);
    }

    /* Блок с адресами */
    var myMapBlock = document.querySelector(mapBlock);
    var myAdressBlock = document.querySelector(adressBlock);
    var oneAdress = myAdressBlock.querySelector(".contacts__one");
    var twoAdress = myAdressBlock.querySelector(".contacts__two");
    var threeAdress = myAdressBlock.querySelector(".contacts__three");
    var fourAdress = myAdressBlock.querySelector(".contacts__four");
    var blockAdress = [oneAdress, twoAdress, threeAdress, fourAdress];

    /* Переключение адресов на карте */

    blockAdress.forEach(function (item) {
      item.addEventListener("click", function (e) {
...
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../services/requests */ "./src/js/services/requests.js");
...
var forms = function forms() {
  try {
    var formsBlock = document.querySelectorAll("form");
    formsBlock.forEach(function (item) {
      /* Общие данные со свсех форм */
      var myButton = item.querySelectorAll("button");
      var myInputs = item.querySelectorAll("input");
      ...
      item.addEventListener("submit", function (e) {
        ...
        if (item.getAttribute("class") === "contacts__form" || item.getAttribute("class") === "opt__form" || item.getAttribute("class") === "drop__form" || item.getAttribute("class") === "vacancy__form" || item.getAttribute("class") === "vacancy__form768") {
          if (clientName.value !== '' && myNumber.value !== '' && myText.value !== '' && politicsBtn.checked === true) {
            ...
            var formSend = new FormData(item);
        ...
        if (item.getAttribute("class") === "installment__form") {
          if (clientName.value !== '' && myNumber.value !== '') {
            ...
            var _formSend = new FormData(item);
            contactsForm(api, _formSend, myButton, myInputs);
          } else {
            myButton.forEach(function (btn) {
              btn.textContent = "Введены не все данные";
              btn.setAttribute('style', 'background-color:red');
    ...
    var contactsForm = function contactsForm(api, formSend, myButton, myInputs) {
      var textarea = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
      var collectionInformation = {};
      var _iterator = _createForOfIteratorHelper(formSend.entries()),
        _step;
      try {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_17__["postData"])(api, collectionInformation).then(function (res) {
        if (res.ok) {
          myButton.forEach(function (btn) {
...
var mainBlock = function mainBlock(bestsalesCard) {
  // const bestsalesBlock = document.querySelectorAll(bestsalesCard);

  var getBlockTopSales = function getBlockTopSales(topsales) {
  ...
  Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getResourse"])("http://localhost:3000/topSales")
  // .then(res => getBlockTopSales(res))
  .then(function (res) {
    return Object(_cards__WEBPACK_IMPORTED_MODULE_1__["default"])(bestsalesCard, res);
  });
};
...
var navbar = function navbar(wrapper) {
  var navbarWrapper = document.querySelector(wrapper);
  var navbarIcon = navbarWrapper.querySelector(".navbar__icon");
  var navbarTel1 = navbarWrapper.querySelector(".navbar__tel1");
  var navbarTel2 = navbarWrapper.querySelector(".navbar__tel2");
  var navbarSchedule = navbarWrapper.querySelector(".navbar__schedule");
  var navbarInputBlock = navbarWrapper.querySelector(".navbar__input");
  var navbarSearch = navbarWrapper.querySelector(".navbar__search");
  var navbarInput = navbarWrapper.querySelector("input");
  var navbarEye = navbarWrapper.querySelector(".navbar__eye");
  var navbarLike = navbarWrapper.querySelector(".navbar__like");
  var navbarCompare = navbarWrapper.querySelector(".navbar__compare");
  var navbarCart = navbarWrapper.querySelector(".navbar__cart");
  var navbarBtnEnter = navbarWrapper.querySelector(".navbar__btnEnter");
  var navbarExit = navbarWrapper.querySelector(".navbar__exit");
  var form = navbarWrapper.querySelector("form");
  var inputBlock = [navbarSearch, navbarInput];
  var formInput = "small";
  inputBlock.forEach(function (element) {
  ...
  var exitInput = function exitInput() {
...
/* harmony import */ var _services_requests__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../services/requests */ "./src/js/services/requests.js");
...
var stocks = function stocks(wrapper, btn) {
  try {
    var wrapperBlock = document.querySelector(wrapper);
    var btnBlock = document.querySelector(btn);
    var prevArrow = btnBlock.querySelector(".stocks__prevArrow");
    var nextArroy = btnBlock.querySelector(".stocks__nextArrow");
    var itemOne = btnBlock.querySelector(".stocks__itemOne");
    var itemTwo = btnBlock.querySelector(".stocks__itemTwo");
    var itemThree = btnBlock.querySelector(".stocks__itemThree");
    var itemLast = btnBlock.querySelector(".stocks__itemLast");
    var viewPage = 1;
    var numberPage = 1;
    var results = [];
    ...
    var getResourseFunction = /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(_services_requests__WEBPACK_IMPORTED_MODULE_25__["getResourse"])("http://localhost:3000/stocks").then(function (res) {
                  return results.push.apply(results, _toConsumableArray(res));
                }).then(function () {
                  return activePage();
                }).then(function () {
                  return setItemBlock(0, 8);
                }).then(function () {
                  return innerWrapper();
                });
              case 2:
      ...
      return function getResourseFunction() {
        return _ref.apply(this, arguments);
      };
    }();

    /* Заполняет mainBlock при первой загрузке и нажатии кнопки страницы */
    var setItemBlock = function setItemBlock(start, end) {
      wrapperBlock.innerHTML = "";
      results.slice(start, end).forEach(function (itemBlock) {
        var itemElement = document.createElement("img");
        itemElement.setAttribute("src", "".concat(itemBlock.src));
        itemElement.setAttribute("alt", "img");
        itemElement.setAttribute("id", "".concat(itemBlock.id));
    ...
    var hightlighting = function hightlighting() {
      [itemOne, itemTwo, itemThree, itemLast].forEach(function (item) {
    ...
    [itemOne, itemTwo, itemThree, itemLast].forEach(function (item) {
      item.addEventListener("click", function () {
        if (item.innerHTML == 1) {
          ...
          var start = (item.textContent - 1) * 8;
          var end = item.textContent * 8;
    ...
    nextArroy.addEventListener("click", function () {
    ...
    var innerWrapper = function innerWrapper() {
      var imgBlock = wrapperBlock.querySelectorAll(".stocks__itemImg");
      imgBlock.forEach(function (item) {
        item.addEventListener("click", function () {
          var itemId = "".concat(item.id);
          fetch("http://localhost:3000/itemId/1", {
            ...
            return Object(_services_requests__WEBPACK_IMPORTED_MODULE_25__["postData"])("http://localhost:3000/itemId/", {
              "idItem": "".concat(itemId)
            });
          }).then(function () {
            return document.location.href = "stocksItem.html";
          });
        });
      });
    };
...
var stocksItem = function stocksItem(linkTitle, title, container, titleLink) {
  try {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResourse"])("http://localhost:3000/itemId").then(function (res) {
      var itemIdBlock = res[0].idItem;
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResourse"])("http://localhost:3000/stocksItem").then(function (responce) {
        var itemStocks = responce.filter(function (item) {
          return item.id === Number(itemIdBlock);
        });
        var linkTitleBlock = document.querySelector(linkTitle);
        var titleBlock = document.querySelector(title);
        var containerBlock = document.querySelector(container);
        var leftContainerBlock = containerBlock.querySelector(".stocks__leftContainer ");
        var rightContainerBlock = containerBlock.querySelector(".stocks__rightContainer ");
        linkTitleBlock.innerHTML = "".concat(itemStocks[0].title);
        titleBlock.innerHTML = "".concat(itemStocks[0].title);

        /* Левый блок контейнера */
        leftContainerBlock.innerHTML = "".concat(itemStocks[0].descr);

        /* Правый блок container */
        var imgBlock = document.createElement("img");
        if (window.screen.width <= "768") {
          imgBlock.setAttribute("src", "".concat(itemStocks[0].src768));
        }
        if (window.screen.width <= "320") {
          imgBlock.setAttribute("src", "".concat(itemStocks[0].src320));
          var aboutUsTitle320 = document.querySelector(titleLink);
          // const aboutUsTitle320 = aboutUsTitle.querySelector(".stocks__aboutUsTitle320")
          aboutUsTitle320.innerHTML = "".concat(itemStocks[0].title);
        }
        if (window.screen.width >= "769") {
          imgBlock.setAttribute("src", "".concat(itemStocks[0].src));
        }
...
/* harmony default export */ __webpack_exports__["default"] = (stocksItem);

/***/ }),

/***/ "./src/js/modules/subnavbar.js":
/*!*************************************!*\
  !*** ./src/js/modules/subnavbar.js ***!
  \*************************************/
/*! exports provided: subnavbar768, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "subnavbar768", function() { return subnavbar768; });
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each.js */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.to-string.js */ "./node_modules/core-js/modules/es.object.to-string.js");
/* harmony import */ var core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_to_string_js__WEBPACK_IMPORTED_MODULE_1__);
...
var subnavbar = function subnavbar(catalogMenu) {
  try {
    /* Внутри нисподающего меню */
    var catalog = document.querySelector(catalogMenu);
    var catalogTitle = catalog.querySelector(".subnavbar__title");
    var catalogItem = catalog.querySelector(".subnavbar__catalogItem");
    var catalogLi = catalogItem.querySelectorAll("li");
    ...
    catalogLi.forEach(function (item) {
      item.addEventListener("click", function (e) {
        catalogLi.forEach(function (item) {
...
var subnavbar768 = function subnavbar768(triggers, catalog, more, search, formDta) {
  var triggersBlok = document.querySelector(triggers); /* Кнопки на меню */
  var catalogBlock = document.querySelector(catalog); /* Блок каталога */
  var moreBlock = document.querySelector(more); /* Блок еще */
  var searchBlock = document.querySelector(search); /* Блок поисковой строки */
  var formDataBlock = document.querySelector(formDta); /* Форма */
  ...
  triggersBlok.addEventListener("click", function (e) {
  ...
  formDataBlock.addEventListener("submit", function (e) {
    e.preventDefault();
    var inputData = formDataBlock.querySelector("[name=info]");
